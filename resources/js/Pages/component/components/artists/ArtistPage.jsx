            ...
            <div className="w-full h-full">
                ...
                <div className="flex flex-col">
                    <div className="flex font-bold text-xl gap-3 p-2 py-4">
                        <div className={`cursor-pointer ${active === 0 ? "text-gray-700" : "text-gray-400 hover:text-gray-500"}`}>Populer</div>
                        <div className={`cursor-pointer ${active === 1 ? "text-gray-700" : "text-gray-400 hover:text-gray-500"}`}>Album</div>
                        <div className={`cursor-pointer ${active === 2 ? "text-gray-700" : "text-gray-400 hover:text-gray-500"}`}>Single</div>
                    </div>
                    <div id="populer">
                        {ARTIST?.musics.map((o, i) => {
                            const filename = getImageFilename(o.single ? o.artwork : o.foto);
